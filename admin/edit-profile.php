...
if(isset($_POST['update']))
{
    ...
    $status=$_POST['status'];
$userid=$_GET['uid'];
    $msg=mysqli_query($con,"update users set fname='$fname',lname='$lname',contactno='$contact',gender='$gender',age='$age',bloodgroup='$bloodgroup',address='$address',status='$status' where id='$userid'");
                     ...
                     <form method="post">
                            <div class="card-body">
                                <table class="table table-bordered">
                                   ...
                                   <tr>
                                    <th>Age</th>
                                       <td><input class="form-control" id="age" name="age" type="text" value="<?php echo $result['age'];?>" required /></td>
                                   </tr>

                                   <tr>
                                    <th>Blood Group</th>
                                       <td><input class="form-control" id="bloodgroup" name="bloodgroup" type="text" value="<?php echo $result['bloodgroup'];?>" required /></td>
                                   </tr>
                                   ...
                                   <tr>
                                    <th>Active Status</th>
                                       <td><input class="form-control" id="status" name="status" type="text" value="<?php echo $result['status'];?>" required /></td>
                                   </tr>
