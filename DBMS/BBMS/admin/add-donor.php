...
if($row>0)
{
    ...
    $msg=mysqli_query($con,"insert into users(fname,lname,email,password,contactno,gender,age,bloodgroup,address,status) values('$fname','$lname','$email','$password','$contact','$gender','$age','$bloodgroup','$address','$status')");
...
<label for="fname">First name<span style="color:red">*</label>
</div>
</div>
...
<div class="col-md-6">
<div class="form-floating">
<input class="form-control" id="age" name="age" type="text" placeholder="Enter your age" required />
 <label for="age">Age<span style="color:red">*</label>
</div>
</div>

<div class="col-md-6">
<div class="font-italic">Gender<span style="color:red">*</span></div>
<div><select id="gender" name="gender" class="form-control" required>
...
<div class="col-md-6">
<div class="form-floating mb-3 mb-md-0">
<input class="form-control" id="contact" name="contact" type="text" placeholder="Enter your Contact" required pattern="[0-9]{11}" title="11 numeric characters only"  maxlength="11" required/>
...
<div class="col-md-6">
<div class="form-floating">
<input class="form-control" id="address" name="address" type="text" placeholder="Enter your last name" required />
 <label for="address">Address<span style="color:red">*</label>
</div>
</div>
</div>
...
<div class="col-md-6">
<div class="font-italic">Active Status<span style="color:red">*</span></div>
<div><select id="status" name="status" class="form-control" required>
<option value="">Select</option>
...
<label for="inputEmail">Email address<span style="color:red">*</label>
</div>
...
<label for="inputPassword">Password<span style="color:red">*</label>
</div>
</div>
...
<label for="inputPasswordConfirm">Confirm Password<span style="color:red">*</label>
</div>
</div>
</div>
...
<div class="small"><a href="manage-users.php">Back to User Management</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
